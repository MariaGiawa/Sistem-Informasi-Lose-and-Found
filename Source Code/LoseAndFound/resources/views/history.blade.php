                                                        ...
                                                        <table class="table table-bordered text-wrap border-bottom w-100" id="delete-datatable">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="wd-15p border-bottom-0" style="width: 4rem;">Nama</th>
                                                                    <th class="wd-20p border-bottom-0" style="width: 4rem;">Merk</th>
                                                                    <th class="wd-20p border-bottom-0" style="width: 8rem;">Deskripsi</th>
                                                            ...
                                                            @foreach ($history as $key => $item)
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center"><span class="badge bg-success-gradient text-dark me-1 mb-1 mt-1">Finished</span></td>
                                                                    <td>
                                                        ...
                                                        <table class="table table-bordered text-wrap border-bottom w-100" id="basic-datatable">
                                                            ...
                                                            @foreach ($expired as $key => $item2)
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center"><span class="badge bg-danger-gradient text-dark  me-1 mb-1 mt-1">Expired</span></td>
                                                                    <td>
